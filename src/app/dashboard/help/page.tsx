export default function Help() {
	return (
		<div>
			<article className="prose prose-gray dark:prose-invert max-w-4xl mx-auto py-12">
				...
				<section className="mt-4">
					...
					<p className="mt-2">
						Welcome to the book publishing service dashboard! This user-friendly
						platform streamlines the publishing process, allowing you to upload
						your book, manage details, track sales, and get support - all in one
						convenient location.
					</p>
					<p className="mt-2">
						...
						quick and easy. Click the prominent `Sign Up`` button and follow the
				...
				<section className="mt-8 flex flex-col gap-2 text-lg">
					...
					<p>
						Our platform currently accepts manuscripts in PDF format for optimal
						quality and consistency. Once you`ve selected the file, you`ll be
						prompted to enter essential details. This includes your book`s
						title, capturing the essence of your work, your author name, and a
						captivating description that will entice potential readers.
					</p>
				</section>
